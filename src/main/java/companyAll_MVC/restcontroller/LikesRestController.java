...
public class LikesRestController {
    ...
    @GetMapping("/list/ratingByCustomerId/{stShowNumber}/{stPageNo}")
    public Map<Check, Object> listLikesWithPaginationCustomerId(@PathVariable String stShowNumber, @PathVariable String stPageNo) {
        return likesDto.listLikesWithPaginationCustomerId(stShowNumber, stPageNo);
    }
